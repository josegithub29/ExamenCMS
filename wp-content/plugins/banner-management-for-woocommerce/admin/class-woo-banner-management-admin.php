...
// If this file is called directly, abort.
	...
	class Woo_Banner_Management_Admin
	{
		...
		public function enqueue_styles()
		{
			...
			if (isset($_GET['page']) && !empty($_GET['page']) && ("banner-setting" == $_GET['page']  || 'wbm-premium' == $_GET['page'] || 'wbm-get-started' == $_GET['page'] || 'wbm-information' == $_GET['page'] ) || isset($_GET['taxonomy']) && !empty($_GET['taxonomy']) && ( 'product_cat' == $_GET['taxonomy'] )) {
		...
		/**
		 *  Set custom menu in woocommerce-banner-managment plugin
		 */
		...
		public function my_custom_submenu_page_callback()
		{
			...
			$wbm_shop_page_stored_results_serialize_banner_open_new_tab = '';
			...
			$wbm_cart_page_stored_results_serialize_banner_open_new_tab = '';
			...
			$wbm_checkout_page_stored_results_serialize_banner_open_new_tab = '';
			...
			$wbm_thankyou_page_stored_results_serialize_banner_open_new_tab = '';
			...
			if (isset($wbm_shop_page_stored_results) && !empty($wbm_shop_page_stored_results)) {
				...
				if (!empty($wbm_shop_page_stored_results_serialize)) {
					...
					$wbm_shop_page_stored_results_serialize_banner_open_new_tab = !empty($wbm_shop_page_stored_results_serialize['shop_page_benner_open_new_tab']) ? $wbm_shop_page_stored_results_serialize['shop_page_benner_open_new_tab'] : '';
				}
			}
			...
			if (isset($wbm_cart_page_stored_results) && !empty($wbm_cart_page_stored_results)) {
				...
				if (!empty($wbm_cart_page_stored_results_serialize)) {
					...
					$wbm_cart_page_stored_results_serialize_banner_open_new_tab = !empty($wbm_cart_page_stored_results_serialize['cart_page_benner_open_new_tab']) ? $wbm_cart_page_stored_results_serialize['cart_page_benner_open_new_tab'] : '';
				}
			}
			...
			if (isset($wbm_checkout_page_stored_results) && !empty($wbm_checkout_page_stored_results)) {
				...
				if (!empty($wbm_checkout_page_stored_results_serialize)) {
					...
					$wbm_checkout_page_stored_results_serialize_banner_open_new_tab = !empty($wbm_checkout_page_stored_results_serialize['checkout_page_benner_open_new_tab']) ? $wbm_checkout_page_stored_results_serialize['checkout_page_benner_open_new_tab'] : '';
				}
			}
			...
			if (isset($wbm_thankyou_page_stored_results) && !empty($wbm_thankyou_page_stored_results)) {
				...
				if (!empty($wbm_thankyou_page_stored_results_serialize)) {
					...
					$wbm_thankyou_page_stored_results_serialize_banner_open_new_tab = !empty($wbm_thankyou_page_stored_results_serialize['thankyou_page_benner_open_new_tab']) ? $wbm_thankyou_page_stored_results_serialize['thankyou_page_benner_open_new_tab'] : '';
				}
			}
            ...
            <div class="wbm-main-table res-cl">
                            ...
                            <td class="forminp mdtooltip">
                                <div class="accordion-section">
                                    ...
                                    <a class="accordion-section-title"
                                       href="#wbm-enable-banner-for-shpe-page"> <?php esc_html_e('Banner for shop page', 'woo-banner-management'); ?>
                                        <span id="shop_page_status_enable_or_disable"
                                              class="shop_page_status_enable_or_disable"
                                              style="color:<?php echo esc_attr($setting_enable_or_color) ?>"><?php echo esc_attr($setting_enable_or_not); ?></span></a>
                                    <div id="wbm-enable-banner-for-shpe-page" class="accordion-section-content">
                                        <table class="form-table" id="form-table-wbm-shop-page">
                                            ...
                                            <tr>
                                                <th scope="row"><label class="wbm_leble_setting_css"
                                                                       for="wbm_enable_shop"><?php esc_html_e('Enable/Disable', 'woo-banner-management'); ?> </label>
                                                </th>
                                                ...
                                                <input type="hidden" id="shop_page_hidden_url"
                                                       value="<?php echo esc_attr($shop_page_url_results); ?>">
                                                <td>
                                                    <span class="Preview_link_for_shop_page"><?php echo wp_kses_post($shop_page_preview_content); ?></span>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
										...
										?>
                                        <div class="wbm_shop_page_enable_open_div"
                                             style="display:<?php echo esc_attr($display_option); ?>">
                                            <fieldset>
                                                <table class="form-table">
                                                    <tbody>
                                                    <tr>
                                                        <th scope="row"><label class="wbm_leble_setting_css"
                                                                               for="banner_url"><?php esc_html_e('Banner Image', 'woo-banner-management'); ?></label>
                                                        </th>
                                                        <td><a class='wbm_shop_page_upload_file_button button'
                                                               uploader_title='Select File'
                                                               uploader_button_text='Include File'><?php esc_html_e('Upload File', 'woo-banner-management'); ?></a>
                                                            <a class='wbm_shop_page_remove_file button'><?php esc_html_e('Remove File', 'woo-banner-management'); ?></a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row"></th>
														<?php
															if ($wbm_shop_page_stored_results_serialize_banner_src == '') {
																$shop_page_banner_css = "none";
															} else {
																$shop_page_banner_css = "block";
															}
														?>
                                                        <td><img class="wbm_shop_page_cat_banner_img_admin"
                                                                 style="display:<?php echo esc_attr($shop_page_banner_css); ?>"
                                                                 src="<?php echo esc_url($wbm_shop_page_stored_results_serialize_banner_src); ?>"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row"><label class="wbm_leble_setting_css"
                                                                               for="banner_link"><?php esc_html_e('Banner Image Link', 'woo-banner-management'); ?></label>
                                                        </th>
                                                        <td><input type="url" id="shop_page_banner_image_link"
                                                                   name='term_meta[banner_link]'
                                                                   value='<?php echo esc_url($wbm_shop_page_stored_results_serialize_banner_link); ?>' placeholder="https://www.google.com/"/>
                                                            <p><label class="banner_link_label"
                                                                      for="banner_link"><em><?php esc_html_e('Where users will be directed if they click on the banner.', 'woo-banner-management'); ?></em></label>
                                                            </p></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row"><label class="wbm_leble_setting_css"
                                                                               for="banner_link"><?php esc_html_e('Enable Open New Tab Link ', 'woo-banner-management'); ?></label>
                                                        </th>
                                                        <td><input type="checkbox" value="open"
                                                                   id="wbm_shop_open_new_tab"
                                                                   class="wbm_shop_open_new_tab_or_not" <?php
																if ($wbm_shop_page_stored_results_serialize_banner_open_new_tab === 'open') {
																	echo " checked ";
																}
															?>>
                                                        </td>
                        ...
                        <tr>
                            <td class="forminp mdtooltip">
                                <div class="accordion-section">
									...
									?>
                                    <a class="accordion-section-title"
                                       href="#wbm-enable-banner-for-cart-page"><?php esc_html_e('Banner for cart page', 'woo-banner-management'); ?>
                                        <span id="cart_page_status_enable_or_disable"
                                              class="shop_page_status_enable_or_disable"
                                              style="color:<?php echo esc_attr($setting_enable_or_color_cart); ?>"> <?php echo esc_attr($setting_enable_or_not_cart); ?></span></a>
                                    <div id="wbm-enable-banner-for-cart-page" class="accordion-section-content">
                                        <div class="woocommerce-banner-managment-cart-setting-admin">
                                            ...
                                            <table class="form-table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="checkbox" value="on"
                                                               id="wbm_shop_setting_cart_enable"
                                                    ...
                                                    <input type="hidden" id="cart_page_hidden_url"
                                                           value="<?php echo esc_url($cart_url_results); ?>">
                                                    <td>
                                                        <span class="Preview_link_for_cart_page"><?php echo wp_kses_post($cart_page_preview_url); ?></span>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
											...
											?>
                                            <div class="wbm-cart-upload-image-html"
                                                 style="display:<?php echo esc_attr($display_option_cart); ?>">
                                                <fieldset>
                                                    <table class="form-table">
                                                        <tbody>
                                                        <tr>
                                                            ...
                                                            <td><a class='wbm_cart_page_upload_file_button button'
                                                                   uploader_title='Select File'
                                                                   uploader_button_text='Include File'><?php esc_html_e('Upload File', 'woo-banner-management'); ?></a>
                                                                <a class='wbm_cart_page_remove_file button'><?php esc_html_e('Remove File', 'woo-banner-management'); ?></a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row"></th>
															...
															?>
                                                            <td><img class="wbm_cart_page_cat_banner_img_admin"
                                                                     style="display:<?php echo esc_attr($cart_page_image_css); ?>"
                                                                     src="<?php echo esc_url($wbm_cart_page_stored_results_serialize_banner_src); ?>"/>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row"><label class="wbm_leble_setting_css"
                                                            ...
                                                            <td><input type="url" id="shop_cart_banner_image_link"
                                                                       name='term_meta[banner_link]'
                                                                       value='<?php echo esc_url($wbm_cart_page_stored_results_serialize_banner_link); ?>' placeholder="https://www.google.com/"/>
                                                                <p><label class="banner_link_label"
                                                                          for="banner_link"><em><?php esc_html_e('Where users will be directed if they click on the banner.', 'woo-banner-management'); ?></em></label>
                                                                </p></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td><input type="checkbox" value="open"
                                                                       id="wbm_cart_open_new_tab"
                                                                       class="wbm_cart_open_new_tab_or_not" <?php
																	if ( 'open' === $wbm_cart_page_stored_results_serialize_banner_open_new_tab ) {
																		echo " checked ";
																	}
																?>>
                                                            </td>
                        ...
                        <tr>
                            <td class="forminp mdtooltip">
                                <div class="accordion-section">
									...
									?>
                                    <a class="accordion-section-title"
                                       href="#wbm-enable-banner-for-checkout-page"><?php esc_html_e('Banner for checkout page ', 'woo-banner-management'); ?>
                                        <span id="checkout_page_status_enable_or_disable"
                                              class="shop_page_status_enable_or_disable"
                                              style="color:<?php echo esc_attr($setting_enable_or_color_checkout); ?>"><?php echo esc_attr($setting_enable_or_not_checkout); ?> </span></a>
                                    <div id="wbm-enable-banner-for-checkout-page" class="accordion-section-content">
                                        <div class="woocommerce-banner-managment-checkout-setting-admin">
                                            <table class="form-table">
                                                ...
                                                <tr>
                                                    ...
                                                    <input type="hidden" id="checkout_page_hidden_url"
                                                           value="<?php echo esc_url($CheckOut_url_real); ?>">
                                                    <td>
                                                        <span class="Preview_link_for_checkout_page"><?php echo wp_kses_post($check_out_preview_content); ?></span>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
											...
											?>
                                            <div class="wbm-checkout-upload-image-html"
                                                 style="display:<?php echo esc_attr($display_option_checkout); ?>">
                                                <fieldset>
                                                    <table class="form-table">
                                                        <tbody>
                                                        <tr>
                                                            ...
                                                            <td><a class='wbm_checkout_page_upload_file_button button'
                                                                   uploader_title='Select File'
                                                                   uploader_button_text='Include File'><?php esc_html_e('Upload File', 'woo-banner-management'); ?></a>
                                                                <a class='wbm_checkout_page_remove_file button'><?php esc_html_e('Remove File', 'woo-banner-management'); ?></a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row"></th>
															...
															?>
                                                            <td><img class="wbm_checkout_page_banner_img_admin"
                                                                     style="display:<?php echo esc_attr($checkout_banner_image_css); ?>"
                                                                     src="<?php echo esc_url($wbm_checkout_page_stored_results_serialize_banner_src); ?>"/>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row"><label class="wbm_leble_setting_css"
                                                            ...
                                                            <td><input type="url" id="shop_checkout_banner_image_link"
                                                                       name='term_meta[banner_link]'
                                                                       value='<?php echo esc_attr($wbm_checkout_page_stored_results_serialize_banner_link); ?>' placeholder="https://www.google.com/"/>
                                                                <p><label class="banner_link_label"
                                                                          for="banner_link"><em><?php esc_html_e('Where users will be directed if they click on the banner.', 'woo-banner-management'); ?></em></label>
                                                                </p></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td><input type="checkbox" value="open"
                                                                       id="wbm_checkout_open_new_tab"
                                                                       class="wbm_checkout_open_new_tab_or_not" <?php
																	if ( 'open' === $wbm_checkout_page_stored_results_serialize_banner_open_new_tab ) {
																		echo " checked ";
																	}
																?>>
                                                            </td>
                        ...
                        <tr>
                            <td class="forminp mdtooltip">
                                <div class="accordion-section">
									...
									?>
                                    <a class="accordion-section-title"
                                       href="#wbm-enable-banner-for-thankyou-page"><?php esc_html_e('Banner for thank you page ', 'woo-banner-management'); ?>
                                        <span id="thankyou_page_status_enable_or_disable"
                                              class="shop_page_status_enable_or_disable"
                                              style="color:<?php echo esc_attr($setting_enable_or_color_thankyou); ?>"><?php echo esc_attr($setting_enable_or_not_thankyou); ?></span></a>
                                    <div id="wbm-enable-banner-for-thankyou-page" class="accordion-section-content">
                                        <div class="woocommerce-banner-managment-thank-you-setting-admin">
											...
											?>
                                            <div class="wbm-thank-you-page-upload-image-html"
                                                 style="display:<?php echo esc_attr($display_option_checkout); ?>">
                                                <fieldset>
                                                    <table class="form-table">
                                                        <tbody>
                                                        <tr>
                                                            ...
                                                            <td><a class='wbm_thank_you_page_upload_file_button button'
                                                                   uploader_title='Select File'
                                                                   uploader_button_text='Include File'><?php esc_html_e('Upload File', 'woo-banner-management'); ?></a>
                                                                <a class='wbm_checkout_page_remove_file button'><?php esc_html_e('Remove File', 'woo-banner-management'); ?></a>
                                                            </td>
                                                        ...
                                                        <tr>
															...
															?>
                                                            <td><img class="wbm_thank_you_page_banner_img_admin"
                                                                     style="display:<?php echo esc_attr($thankyou_page_image_css); ?>"
                                                                     src="<?php echo esc_url($wbm_thankyou_page_stored_results_serialize_banner_src); ?>"/>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row"><label class="wbm_leble_setting_css"
                                                            ...
                                                            <td><input type="url"
                                                                       id="shop_thank_you_page_banner_image_link"
                                                                       name='term_meta[banner_link]'
                                                                       value='<?php echo esc_attr($wbm_thankyou_page_stored_results_serialize_banner_link); ?>' placeholder="https://www.google.com/"/>
                                                                <p><label class="banner_link_label"
                                                                          for="banner_link"><em><?php esc_html_e('Where users will be directed if they click  on the banner.', 'woo-banner-management'); ?></em></label>
                                                                </p></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td><input type="checkbox" value="open"
                                                                       id="wbm_thankyou_open_new_tab"
                                                                       class="wbm_thankyou_open_new_tab_or_not" <?php
																	if (  'open' === $wbm_thankyou_page_stored_results_serialize_banner_open_new_tab ) {
																		echo " checked ";
																	}
																?>>
                                                            </td>
                        ...
                        <td class="forminp mdtooltip">
                            <div class="category_based_settings">
                                ...
                                <img class="preview_category_page_image"
                                     src="<?php echo esc_url(WooCommerce_Banner_Management_Url . 'admin/assets/images/category_setting_image.png'); ?>">
                                <p><strong><?php esc_html_e('Go to category page', 'woo-banner-management'); ?></strong>
                                    <a target="_blank"
                                       href="<?php echo esc_url(site_url() . '/wp-admin/edit-tags.php?taxonomy=product_cat&post_type=product'); ?>"><?php esc_html_e('click here', 'woo-banner-management'); ?></a>
                                </p>
                            </div>
                        </td>
                    </tr>
                ...
                <input type="button" name="save_wbmshop" id="save_wbm_shop_page_setting" class="button button-primary"
                       value="<?php esc_html_e('Save Changes', 'woo-banner-management'); ?>">
            </div>
			<?php
		...
		function wbm_product_add_taxonomy_custom_fields($tag)
		{
            ...
            <tr class="form-field mdwbm_banner_url_form_field">
                ...
                <td>
                    <fieldset>
                        <a class='mdwbm_add_cat_upload_file_button button' uploader_title='Select File'
                           uploader_button_text='Include File'><?php esc_html_e('Upload File', 'woo-banner-management'); ?></a>
            ...
            <tr class="form-field auto_display_banner">
                ...
                <td>
                    <fieldset>
                        <input name="term_meta[auto_display_banner]" type="checkbox" checked value="on"
                               class="auto_display_banner" id="auto_display_banner_create_new"/>
		...
		function WBM_product_cat_taxonomy_custom_fields($tag)
		{
            ...
            <tr class="form-field mdwbm_banner_url_form_field">
                ...
                <td>
                    <fieldset>
                        <a class='mdwbm_upload_file_button button' uploader_title='Select File'
                           uploader_button_text='Include File'><?php esc_html_e('Upload File', 'woo-banner-management'); ?></a>
                    ...
                    <fieldset>
						...
						?>
                        <img class="cat_banner_img_admin" style="display:<?php echo esc_attr($category_banner_css); ?>"
                             src="<?php if ($banner_id != null) echo esc_url(wp_get_attachment_url($banner_id)); ?>"/>
                    </fieldset>

                    <input type="hidden" class='mdwbm_image' name='term_meta[banner_url_id]'
                           value='<?php if ($banner_id != null) echo esc_attr($banner_id); ?>'/>
                </td>
            </tr>
            <tr class="form-field banner_link_form_field">
                <th scope="row" valign="top">
                ...
                <td>
                    <fieldset>
                        <input type="url" name='term_meta[banner_link]'
                               value='<?php if ($banner_link != null) echo esc_url($banner_link); ?>'/>
                        <label class="banner_link_label"
                               for="banner_link"><em><?php esc_html_e('Where users will be directed if they click on the banner.', 'woo-banner-management'); ?></em></label>
                    </fieldset>
                </td>
            ...
            <tr class="form-field auto_display_banner">
                ...
                <td>
                    <fieldset>
                        <input name="term_meta[auto_display_banner]" type="checkbox" value="on"
                               class="auto_display_banner" <?php if ($auto_display_banner) echo " checked "; ?>/>
                        <label class="auto_display_banner_label" for="auto_display_banner"><em></em></label>
                    </fieldset>
                </td>
            </tr>
		...
		public function wbm_save_shop_page_banner_data()
		{
			...
			$shop_page_banner_open_new_tab_results = !empty($_POST['shop_page_benner_open_new_tab_results']) ? sanitize_text_field(wp_unslash($_POST['shop_page_benner_open_new_tab_results'])) : '';
			...
			$cart_page_banner_open_new_tab_results = !empty($_POST['cart_page_benner_open_new_tab_results']) ? sanitize_text_field(wp_unslash($_POST['cart_page_benner_open_new_tab_results'])) : '';
			...
			$checkout_page_banner_open_new_tab_results = !empty($_POST['checkout_page_benner_open_new_tab_results']) ? sanitize_text_field(wp_unslash($_POST['checkout_page_benner_open_new_tab_results'])) : '';
			...
			$thankyou_page_banner_open_new_tab_results = !empty($_POST['thankyou_page_benner_open_new_tab_results']) ? sanitize_text_field(wp_unslash($_POST['thankyou_page_benner_open_new_tab_results'])) : '';
			...
			$shop_page_data_stored_array = array(
				...
				'shop_page_benner_open_new_tab' => $shop_page_banner_open_new_tab_results,
			);
			...
			$cart_page_data_stored_array = array(
				...
				'cart_page_benner_open_new_tab' => $cart_page_banner_open_new_tab_results,
			);
			...
			$checkout_page_data_stored_array = array(
				...
				'checkout_page_benner_open_new_tab' => $checkout_page_banner_open_new_tab_results,
			);
			...
			$thankyou_page_data_stored_array = array(
				...
				'thankyou_page_benner_open_new_tab' => $thankyou_page_banner_open_new_tab_results,
			);
		...
		public function wbm_show_shop_page_banner()
		{
			...
			if (isset($wbm_shop_page_stored_results) && !empty($wbm_shop_page_stored_results)) {
				...
				if (!empty($wbm_shop_page_stored_results_serialize)) {
					...
					$wbm_shop_page_stored_results_serialize_banner_alt = array_reverse(explode('/', $wbm_shop_page_stored_results_serialize_banner_src));
					if (!empty($wbm_shop_page_stored_results_serialize_banner_src)) {
						if (!empty($wbm_shop_page_stored_results_serialize_banner_alt)) {
							$wbm_shop_page_stored_results_serialize_banner_alt_results = array_reverse(explode('.', $wbm_shop_page_stored_results_serialize_banner_src));
							if (!empty($wbm_shop_page_stored_results_serialize_banner_alt_results)) {
								$wbm_shop_page_stored_results_serialize_banner_alt_results = array_reverse(explode('/', $wbm_shop_page_stored_results_serialize_banner_alt_results[1]));
								$alt_tag_value = $wbm_shop_page_stored_results_serialize_banner_alt_results[0];
							}
						}
					}
				}
			...
			if (is_shop()) {
				if (!empty($wbm_shop_page_stored_results_serialize_banner_open_new_tab) && $wbm_shop_page_stored_results_serialize_banner_open_new_tab === 'open') {
					$test = "_blank";
				} else {
					$test = "_self";
				}
				?>
				<?php if (!empty($wbm_shop_page_stored_results_serialize_banner_enable_status) && $wbm_shop_page_stored_results_serialize_banner_enable_status === 'on') {
					?>
                    <div class="wbm_banner_image">
						<?php
							if ($wbm_shop_page_stored_results_serialize_banner_link == '') {
								...
								$alt_tag_css_shop_page_fornt = 'style=cursor:pointer href=' . esc_url($wbm_shop_page_stored_results_serialize_banner_link) . ' target=' . esc_attr($test) . '';
							}
						?>
                        <a <?php echo esc_attr($alt_tag_css_shop_page_fornt); ?>>
                            <p><img src="<?php echo esc_url($wbm_shop_page_stored_results_serialize_banner_src); ?>"
                                    class="category_banner_image" alt="<?php echo esc_attr($alt_tag_value); ?>"></p>
                        </a>
                    </div>
					<?php
				}
		...
		public function wbm_show_cart_page_banner()
		{
			...
			if (isset($wbm_cart_page_stored_results) && !empty($wbm_cart_page_stored_results)) {
				...
				if (!empty($wbm_cart_page_stored_results_serialize)) {
					...
					$wbm_cart_page_stored_results_serialize_banner_alt = array_reverse(explode('/', $wbm_cart_page_stored_results_serialize_banner_src));
					if (!empty($wbm_cart_page_stored_results_serialize_banner_src)) {
						if (!empty($wbm_cart_page_stored_results_serialize_banner_alt)) {
							$wbm_cart_page_stored_results_serialize_banner_alt_results = array_reverse(explode('.', $wbm_cart_page_stored_results_serialize_banner_src));
							if (!empty($wbm_cart_page_stored_results_serialize_banner_alt_results)) {
								$wbm_cart_page_stored_results_serialize_banner_alt_results = array_reverse(explode('/', $wbm_cart_page_stored_results_serialize_banner_alt_results[1]));
								$alt_tag_value = $wbm_cart_page_stored_results_serialize_banner_alt_results[0];
							}
						}
					}
				}
			}
			if (!empty($wbm_cart_page_stored_results_serialize_banner_open_new_tab) && $wbm_cart_page_stored_results_serialize_banner_open_new_tab === 'open') {
				$test = "_blank";
			} else {
				$test = "_self";
			}
                ...
                <div class="wbm_banner_image">
					<?php
						if ($wbm_cart_page_stored_results_serialize_banner_link == '') {
							...
							$alt_tag_css_cart_page_fornt = 'style=cursor:pointer href=' . esc_url($wbm_cart_page_stored_results_serialize_banner_link) . ' target=' . esc_attr($test) . '';
						}
					?>
                    <a <?php echo esc_attr($alt_tag_css_cart_page_fornt); ?>>
                        <p><img src="<?php echo esc_url($wbm_cart_page_stored_results_serialize_banner_src); ?>"
                                class="cart_banner_image" alt="<?php echo esc_attr($alt_tag_value); ?>"></p>
                    </a>
                </div>
				<?php
			}
		...
		public function wbm_show_checkout_page_banner()
		{
			...
			if (isset($wbm_checkout_page_stored_results) && !empty($wbm_checkout_page_stored_results)) {
				...
				if (!empty($wbm_checkout_page_stored_results_serialize)) {
					...
					$wbm_checkout_page_stored_results_serialize_banner_alt = array_reverse(explode('/', $wbm_checkout_page_stored_results_serialize_banner_src));
					if (!empty($wbm_checkout_page_stored_results_serialize_banner_src)) {
						if (!empty($wbm_checkout_page_stored_results_serialize_banner_alt)) {
							$wbm_checkout_page_stored_results_serialize_banner_alt_results = array_reverse(explode('.', $wbm_checkout_page_stored_results_serialize_banner_src));
							if (!empty($wbm_checkout_page_stored_results_serialize_banner_alt_results)) {
								$wbm_checkout_page_stored_results_serialize_banner_alt_results = array_reverse(explode('/', $wbm_checkout_page_stored_results_serialize_banner_alt_results[1]));
								$alt_tag_value = $wbm_checkout_page_stored_results_serialize_banner_alt_results[0];
							}
						}
					}
				}
			}
			if (!empty($wbm_checkout_page_stored_results_serialize_banner_open_new_tab) && $wbm_checkout_page_stored_results_serialize_banner_open_new_tab === 'open') {
				$test = "_blank";
			} else {
				$test = "_self";
			}
                ...
                <div class="wbm_banner_image">
					<?php
						if ($wbm_checkout_page_stored_results_serialize_banner_link == '') {
							...
							$alt_tag_css_checkout_page_fornt = 'style=cursor:pointer href=' . esc_url($wbm_checkout_page_stored_results_serialize_banner_link) . ' target=' . esc_attr($test) . '';
						}
					?>
                    <a <?php echo esc_attr($alt_tag_css_checkout_page_fornt); ?>>
                        <p><img src="<?php echo esc_url($wbm_checkout_page_stored_results_serialize_banner_src); ?>"
                                class="checkout_banner_image" alt="<?php echo esc_attr($alt_tag_value); ?>"></p>
                    </a>
                </div>
				<?php
			}
		...
		public function wbm_show_thankyou_page_banner()
		{
			...
			if (isset($wbm_thankyou_page_stored_results) && !empty($wbm_thankyou_page_stored_results)) {
				...
				if (!empty($wbm_thankyou_page_stored_results_serialize)) {
					...
					$wbm_thankyou_page_stored_results_serialize_banner_alt = array_reverse(explode('/', $wbm_thankyou_page_stored_results_serialize_banner_src));
					if (!empty($wbm_thankyou_page_stored_results_serialize_banner_src)) {
						if (!empty($wbm_thankyou_page_stored_results_serialize_banner_alt)) {
							$wbm_thankyou_page_stored_results_serialize_banner_alt_results = array_reverse(explode('.', $wbm_thankyou_page_stored_results_serialize_banner_src));
							if (!empty($wbm_thankyou_page_stored_results_serialize_banner_alt_results)) {
								$wbm_thankyou_page_stored_results_serialize_banner_alt_results = array_reverse(explode('/', $wbm_thankyou_page_stored_results_serialize_banner_alt_results[1]));
								$alt_tag_value = $wbm_thankyou_page_stored_results_serialize_banner_alt_results[0];
							}
						}
					}
				}
			...
			if (!empty($wbm_thankyou_page_stored_results_serialize_banner_enable_status) && $wbm_thankyou_page_stored_results_serialize_banner_enable_status === 'on') {
				?>
                <div class="wbm_banner_image">
					<?php
						if ($wbm_thankyou_page_stored_results_serialize_banner_link == '') {
							$alt_tag_css_thankyou_page_fornt = 'style=cursor:default';
						} else {
							$alt_tag_css_thankyou_page_fornt = 'style=cursor:pointer href=' . esc_url($wbm_thankyou_page_stored_results_serialize_banner_link) . ' target="_blank"';
						}
					?>
                    <a <?php echo esc_attr($alt_tag_css_thankyou_page_fornt); ?>>
                        <p><img src="<?php echo esc_url($wbm_thankyou_page_stored_results_serialize_banner_src); ?>"
                                class="checkout_banner_image" alt="<?php echo esc_attr($alt_tag_value); ?>"></p>
                    </a>
                </div>
				<?php
		...
		public function welcome_banner_mamagement_for_woocommerce_screen_do_activation_redirect()
		{
			if (!get_transient('_banner_management_for_woocommerce_welcome_screen')) {
				return;
			}
			
			// Delete the redirect transient
			delete_transient('_banner_management_for_woocommerce_welcome_screen');
		...
		public function welcome_screen_banner_mamagement_for_woocommerce_remove_menus()
		{
